    ...
    "archives" => [
        ...
        [
            ...
            "paths" => [
                ...
                ["path" => "/storage/emulated/0/Android/data/ru.onjion.mobile/files/texdb/menu"],
                ["path" => "/storage/emulated/0/Android/data/ru.onjion.mobile/files/texdb/mobile"],
                ["path" => "/storage/emulated/0/Android/data/ru.onjion.mobile/files/texdb/player"],
                ["path" => "/storage/emulated/0/Android/data/ru.onjion.mobile/files/texdb/radar"],
                ["path" => "/storage/emulated/0/Android/data/ru.onjion.mobile/files/texdb/samp"],
        ...
        [
            ...
            "paths" => [
                ...
                ["path" => "/storage/emulated/0/Android/data/ru.onjion.mobile/files/texdb/player.img"],
                ["path" => "/storage/emulated/0/Android/data/ru.onjion.mobile/files/texdb/samp.img"],
...
echo json_encode($data, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES); // Выводим данные в формате JSON
?>
